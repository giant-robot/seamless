(function($) {
    ...
    {
        return window.console.info('Seamless needs jQuery.');
    }

    if (typeof $.fn.waypoint === 'undefined' && 'console' in window)
    {
        return window.console.info('Seamless needs jQuery.Waypoints.');
    }
